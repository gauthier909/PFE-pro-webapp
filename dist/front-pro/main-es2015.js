...
let ConfigurationJeuxComponent = class ConfigurationJeuxComponent {
    constructor(configurationPartieSevice, listeDonneesService, renderer, socketService, enfantService) {
...
ConfigurationJeuxComponent.ctorParameters = () => [
...
let EnfantAjoutComponent = class EnfantAjoutComponent {
    constructor(route, enfantService, listeDonneesServices, location, gestionProService) {
        this.route = route;
        this.enfantService = enfantService;
    ...
    add(nom, prenom, date_naissance, langue_usuelle, dominance, _enseignement, _niveau) {
...
let EnfantDetailComponent = class EnfantDetailComponent {
    constructor(route, enfantService, location, listeDonneesService, gestionProfessionnelService) {
        this.route = route;
        this.enfantService = enfantService;
        this.location = location;
        this.listeDonneesService = listeDonneesService;
...
let HistoriquePartieComponent = class HistoriquePartieComponent {
    constructor(enfantService, listeDonneesService) {
        this.enfantService = enfantService;
        this.listeDonneesService = listeDonneesService;
    }
    ngOnInit() {
...
HistoriquePartieComponent.ctorParameters = () => [
...
let PersonneAjoutComponent = class PersonneAjoutComponent {
    ...
    add(nom, prenom, password, profession, telephone, email, role, idParentEnfant) {
        // trim() => remove whitespace
        nom = nom.trim();
        prenom = prenom.trim();
        if (!nom) {
        ...
        this.gestionProService.addPersonne({ password, nom, prenom, profession, telephone, email, role, idParentEnfant })
            .subscribe(personne => {
            this.goBack();
        });
    }
...
let PersonneDetailComponent = class PersonneDetailComponent {
    constructor(route, gestionProService, location, listeDonneesService, enfantService) {
        this.route = route;
        this.gestionProService = gestionProService;
        this.location = location;
        this.listeDonneesService = listeDonneesService;
...
let TransfertEnfantComponent = class TransfertEnfantComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ConfigurationPartieService = class ConfigurationPartieService {
    ...
    */
        return this.http.post(this.partieUrl, partie, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((newPartie) => console.log(`added Partie w/ id=${newPartie._id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('addPartie')));
    }
    ...
    getParties() {
        console.log("aa");
        return this.http.get(this.partieUrl, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((newPartie) => console.log(`added Partie w/ id=${newPartie._id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('addPartie')));
    }
...
ConfigurationPartieService.ctorParameters = () => [
...
let EnfantService = class EnfantService {
    ...
    getEnfantsPro(id) {
        ...
        this.enfants = this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => console.log(`fetched enfants du pro id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getEnfantsPro', [])));
        return this.enfants;
    ...
    getEnfant(id) {
        ...
        const url = `${this.enfantsUrl}/${id}`;
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => console.log(`fetched enfants id=${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(`getEnfant id=${id}`)));
    }
...
let GestionProfessionnelService = class GestionProfessionnelService {
    ...
    getProfessionnels() {
        ...
        this.personnes = this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => console.log('fetched professionnels')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getProfessionnels', [])));
        return this.personnes;
    }
    // add personne to DB
...
let ListeDonneesService = class ListeDonneesService {
    ...
    getDemandeurs() {
        ...
        this.demandeurs = this.http.get(demandeursUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => console.log('fetched demandeurs')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getDemandeurs', [])));
