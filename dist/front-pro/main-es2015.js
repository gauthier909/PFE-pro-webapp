...
let ResponsableRegisterComponent = class ResponsableRegisterComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
const routes = [
    {
        ...
        path: 'responsable',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./responsable/responsable.module */ "./src/app/responsable/responsable.module.ts")).then(mod => mod.ResponsableModule),
        canLoad: [_auth_responssible_guard__WEBPACK_IMPORTED_MODULE_9__["AuthGuardR"]]
    },
    {
        path: 'professionel',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./professionelle/professionelle.module */ "./src/app/professionelle/professionelle.module.ts")).then(mod => mod.ProfessionelleModule),
        canLoad: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]]
    },
    {
        path: 'parent',
        loadChildren: () => __webpack_require__.e(/*! import() | parent-parent-module */ "parent-parent-module").then(__webpack_require__.bind(null, /*! ./parent/parent.module */ "./src/app/parent/parent.module.ts")).then(mod => mod.ParentModule),
...
let AuthGuardP = class AuthGuardP {
    constructor(authService, router) {
        this.authService = authService;
        this.router = router;
    }
...
let AuthGuardR = class AuthGuardR {
    constructor(authService, router) {
        this.authService = authService;
        this.router = router;
    }
...
let ParentRoutingModule = class ParentRoutingModule {
};
...
let PersonneAjoutComponent = class PersonneAjoutComponent {
    ...
    add(password, nom, prenom, profession, telephone, email, role) {
        // trim() => remove whitespace
        nom = nom.trim();
        prenom = prenom.trim();
        if (!nom) {
        ...
        this.gestionProService.addPersonne({ password, nom, prenom, profession, telephone, email, role })
            .subscribe(personne => {
            this.goBack();
        });
    }
...
let ProfessionelleDashboardComponent = class ProfessionelleDashboardComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ProfessionelleRoutingModule = class ProfessionelleRoutingModule {
};
...
let ProfessionelleModule = class ProfessionelleModule {
};
...
let ProfessionelleComponent = class ProfessionelleComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let RegisterProfessionnelComponent = class RegisterProfessionnelComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ResponsableRoutingModule = class ResponsableRoutingModule {
};
...
let ResponsableModule = class ResponsableModule {
};
...
let ResponsableComponent = class ResponsableComponent {
    constructor() { }
    ngOnInit() {
    }
};
